...
tonnellate/ora in kilogrammi/secondo, ossia dividere per 3.6. Il risultato sarà 1.524 kg/s di gas naturale immessi nel generatore di vapore.
...
La potenza termica contenuta nel combustibile è pari invece alla portata di combustibile per il suo potere calorifico inferiore:
1.524 kg/s per 47.7 MJ/kg ossia 72.716 MW.
...
che l'acqua si trova nella condizione di liquido saturo; è quindi possibile leggere la pressione dalla stessa tabella.
...
Il rendimento limite ha come limite superiore il rendimento del ciclo ideale di Carnot che avverrebbe tra le stesse temmperature medie di adduzione e sottrazione
...
Consideriamo la portata massica in turbina pari a 70.72 t/h, pari a 19.65 kg/s. La variazione di entalpia è pari a 254.9 kcal/kg, o equivalentemente a 1067 kJ/kg.
La potenza ottenuta dalla turbina è dunque 20.960 MW.

Nell'impianto sono presenti 2 pompe: una pompa di estrazione dal condensatore ed una pompa di alimento verso il generatore
