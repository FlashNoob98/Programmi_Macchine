...
Per il calcolo del rendimento globale è necessario valutare la potenza utile all'asse della turbina valutabile come 
la portata di fluido per il salto di entalpia al quale va sottratta la potenza meccanica necessaria al funzionamento
...
Definito nella \eqref{eq:rendimento_combustione} il rendimento di combustione
