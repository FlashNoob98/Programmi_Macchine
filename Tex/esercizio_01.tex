...
\textit{Pressione massima:} il valore di massima pressione all'uscita del compressore 

\textit{Portata d'aria:} quantità d'aria aspirata in l/min 

\textit{Potenza motore:} potenza massima erogabile dal motore
...
\begin{equation*}
    \dot{m} = \frac{\dot{V}}{v}
\end{equation*}
dove \textit{v} è il volume specifico del gas e $\dot{V}$ è espressa in $m^3/s$.
