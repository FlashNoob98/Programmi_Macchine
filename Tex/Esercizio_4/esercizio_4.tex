...
Si può indicare con $B$ le condizioni di ristagno dello stato 2, non è possibile fare l'ipotesi di trasformazione isoentropica dato che la pressione ambiente è fissata
e il fluido fermo non potrebbe avere una pressione una maggiore, ci spostiamo dunque lungo l'isobara inferiore aumentando temperatura ed entropia.
Valutiamo quindi la differenza di entalpia e ripetiamo i passaggi precedenti.
\begin{center}
    \begin{tabular}{c|c|c|c}
        Stato   &p (bar)    &T (°C) &v ($m^3/kg$) \\ \hline
        A       &2.58       &104.8  &0.420  \\
